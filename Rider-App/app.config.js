  ...
  ios: {
    ...
    infoPlist: {
      NSCameraUsageDescription:
        "Camera access required for delivery signature capture",
      NSLocationAlwaysAndWhenInUseUsageDescription:
        "Location required for real-time fleet tracking and route optimization",
      NSLocationAlwaysUsageDescription:
        "Background location for continuous fleet telemetry",
      NSLocationWhenInUseUsageDescription:
        "Location needed to navigate delivery addresses",
  ...
  plugins: [
    ...
    [
      "expo-notifications",
      {
        ...
        sounds: ["./assets/cash_register.mp3"],
      },
    ],
  ],
